...
public class Round4TitleLayer extends CCColorLayer
{
	...
	public static CCScene scene(String message)
	{
		...
		Round4TitleLayer layer = new Round4TitleLayer(ccColor4B.ccc4(255, 255, 255, 255));
	...
	protected Round4TitleLayer(ccColor4B color)
	{
		super(color);
	...
	{
		CCScene scene = GameLayer4.scene();
