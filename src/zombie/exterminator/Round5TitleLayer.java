...
public class Round5TitleLayer extends CCColorLayer
{
	...
	public static CCScene scene(String message)
	{
		...
		Round5TitleLayer layer = new Round5TitleLayer(ccColor4B.ccc4(255, 255, 255, 255));
	...
	protected Round5TitleLayer(ccColor4B color)
	{
		super(color);
	...
	{
		CCScene scene = GameLayer5.scene();
