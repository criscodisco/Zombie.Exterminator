...
public class Round6TitleLayer extends CCColorLayer
{
	...
	public static CCScene scene(String message)
	{
		...
		Round6TitleLayer layer = new Round6TitleLayer(ccColor4B.ccc4(255, 255, 255, 255));
	...
	protected Round6TitleLayer(ccColor4B color)
	{
		super(color);
	...
	{
		CCScene scene = GameLayer6.scene();
