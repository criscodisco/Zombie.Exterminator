...
public class Round7TitleLayer extends CCColorLayer
{
	...
	public static CCScene scene(String message)
	{
		...
		Round7TitleLayer layer = new Round7TitleLayer(ccColor4B.ccc4(255, 255, 255, 255));
	...
	protected Round7TitleLayer(ccColor4B color)
	{
		super(color);
	...
	{
		CCScene scene = GameLayer7.scene();
