...
public class Round8TitleLayer extends CCColorLayer
{
	...
	public static CCScene scene(String message)
	{
		...
		Round8TitleLayer layer = new Round8TitleLayer(ccColor4B.ccc4(255, 255, 255, 255));
	...
	protected Round8TitleLayer(ccColor4B color)
	{
		super(color);
	...
	{
		CCScene scene = GameLayer8.scene();
