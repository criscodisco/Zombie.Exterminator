...
public class Round9TitleLayer extends CCColorLayer
{
	...
	public static CCScene scene(String message)
	{
		...
		Round9TitleLayer layer = new Round9TitleLayer(ccColor4B.ccc4(255, 255, 255, 255));
	...
	protected Round9TitleLayer(ccColor4B color)
	{
		super(color);
	...
	{
		CCScene scene = GameLayer9.scene();
