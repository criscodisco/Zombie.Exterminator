...
public class YouLoseLayer extends CCColorLayer
{
	...
	public static CCScene scene(String message)
	{
		...
		YouLoseLayer layer = new YouLoseLayer(ccColor4B.ccc4(255, 255, 255, 255));
	...
	protected YouLoseLayer(ccColor4B color)
	{
		super(color);
	...
	{
		CCDirector.sharedDirector().replaceScene(Round1TitleLayer.scene("Level 1  Wave 1"));
	}
