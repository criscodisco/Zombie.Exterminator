...
public class YouWinLayer extends CCColorLayer
{
	...
	public static CCScene scene(String message)
	{
		...
		YouWinLayer layer = new YouWinLayer(ccColor4B.ccc4(255, 255, 255, 255));
	...
	protected YouWinLayer(ccColor4B color)
	{
		super(color);
	...
	{
		CCScene scene = MainTitle.scene("CREDITS: Programming by Kyle   Graphics by Briz, James, & Micah");
